...
export default async function handler(req, res) {
  ...
  try {
    ...
    res.setHeader('Cache-Control', res.setHeader('Cache-Control', 's-maxage=300, stale-while-revalidate=60'); // cache 5 min, ahorra créditos); // cache 1 min, los scores cambian rápido
